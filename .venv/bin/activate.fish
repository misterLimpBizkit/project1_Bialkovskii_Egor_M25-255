...
set -gx VIRTUAL_ENV /Users/limpbizkit/Desktop/project1_Bialkovskii_Egor_M25-255/.venv
...
if test -n project1-bialkovskii-egor-m25-255-py3.12
    set -gx VIRTUAL_ENV_PROMPT project1-bialkovskii-egor-m25-255-py3.12
else
